...
md`#   HW04 Sunburst 
# (Simple Baseline and Medium Baseline)`
)}

function _artist1(__query,FileAttachment,invalidation){return(
__query(FileAttachment("artist@1.csv"),{select:{columns:null},from:{table:"artist"},filter:[],sort:[],slice:{from:null,to:null}},invalidation)
)}
...
md`**- 依照工作地點將填寫問卷的民眾進行分類，主要以工作室、替代空間、非營利組織/藝術團體、美術館、校院，為五大族群，其中又以藝術工作者佔多數。**`
)}

function _12(md){return(
md`**- 在減少碳排放的行動中，以『減少包裝、再生材料、節約能源』佔大多數，除了在美術館中減少商務差旅更高於再生材料外，其餘皆是這三項為人們主要採取的行動**
`
)}
...
d3
  ...
  .range(["#66B3FF","	#97CBFF","#C4E1FF","#BE77FF","#D3A4FF","	#E6CAFF"])
  .unknown("#BEBEBE")
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof breadcrumb")).define("viewof breadcrumb", ["d3","breadcrumbWidth","breadcrumbHeight","sunburst","breadcrumbPoints","color"], _breadcrumb);
  main.variable(observer("breadcrumb")).define("breadcrumb", ["Generators", "viewof breadcrumb"], (G, _) => G.input(_));
