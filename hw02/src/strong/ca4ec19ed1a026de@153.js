...
function _6(yCounts,constellationName,data)
{
...
function _9(Plot,plot2,constellationName,yCounts){return(
Plot.plot({
  marginTop: plot2.mt,
...
function _12(Plot,plot1,data,constellationName){return(
Plot.plot({  
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["yCounts","constellationName","data"], _6);
  ...
  main.variable(observer()).define(["Plot","plot2","constellationName","yCounts"], _9);
  ...
  main.variable(observer()).define(["Plot","plot1","data","constellationName"], _12);
  return main;
}
