...
function _13(Plot,data,constellationName){return(
Plot.plot({
  y: {grid: true, label: "count"},
  x: {label: "Constellation"},
  marks: [    
		Plot.rectY(data, Plot.binX({y:"count"}, { x:"Constellation", interval:1, fill:"Gender", title: (d,i) => `Constellation: ${constellationName[d.Constellation]},\n Gender: ${d.Gender}:`, tip: true})),    
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Plot","data","constellationName"], _13);
  return main;
}
