...
function _group_03(FileAttachment){return(
FileAttachment("group_03.json").json()
)}
...
function _output1(d3,group_03,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000
    ;
  ...
  // 計算圖形並啟動力模擬。
  const root = d3.hierarchy(group_03);
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["group_03.json", {url: new URL("./files/1dd40d06401ea69f1e3cdcdd2ea129638845754fd623a8bf2aa6d0166b0f30f62e0f37f4db284d32f533c12c9eb02fc317f87c1e6dc61364e3e0d02b5d5ceeb7.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer()).define(["md"], _2);
  main.variable(observer("group_03")).define("group_03", ["FileAttachment"], _group_03);
  main.variable(observer("url_list")).define("url_list", _url_list);
  main.variable(observer("output1")).define("output1", ["d3","group_03","drag","url_list","invalidation"], _output1);
